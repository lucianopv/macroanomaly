...
outliertree_rank <- roworder(outliertree_rank,WDI_order)
isoforest_rank <- readRDS("WDI_isoforest_data")
isoforest_rank <- roworder(isoforest_rank,WDI_order)
norm_zscore_isoforest_rank<-readRDS("norm_zscore_isoforest")
norm_zscore_isoforest_rank <- roworder(norm_zscore_isoforest_rank,WDI_order)

norm_outliertree_rank <- readRDS("WDI_norm_outlier_tree_data")
norm_outliertree_rank <- roworder(norm_outliertree_rank,WDI_order)
...
wdi_df_long$Zscore_isoforest_rank <- norm_zscore_isoforest_rank$norm_isoforest_rank
wdi_df_long$Zscore_outliertree_rank <- norm_outliertree_rank$outlier_tree_rank
