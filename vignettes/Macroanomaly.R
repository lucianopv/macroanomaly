...
nobs <- fnobs(wdi_data_long_subset$Indicator.Value,
              g=wdi_data_long_subset[c("Country.Code","Indicator.Code")],TRA=2)
wdi_data_long_subset |> fsubset(!is.na(nobs)) -> wdi_data_long_subset_filtered
